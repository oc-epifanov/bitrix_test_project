...
<img src="<?=$templateFolder?>/bitrix/templates/test/images/punkt_top.gif" width="4" height="4" border="0" alt="">&nbsp;&nbsp;<a href="<?=$arResult["AUTH_REGISTER_URL"]?>" onclick="return ShowLoginForm();"><?=GetMessage("AUTH_LOGIN_BUTTON")?></a>&nbsp;&nbsp;&nbsp;&nbsp;
<img src="<?=$templateFolder?>/bitrix/templates/test/images/punkt_top.gif" width="4" height="4" border="0" alt="">&nbsp;&nbsp;<a href="<?=$arResult["AUTH_REGISTER_URL"]?>"><?=GetMessage("AUTH_REGISTER")?></a>
</div>
<?else:?>
<div id="login-info">
...
<?endforeach?>
	...
	<input type="image" src="<?=$templateFolder?>/bitrix/templates/test/images/punkt_top.gif" width="4" height="4" alt="<?=GetMessage("AUTH_LOGOUT_BUTTON")?>">
</form>
</div>
<?endif?>